 ...
 * Faqs Model
 *
 * @property \App\Model\Table\CategoryDatasetsTable&\Cake\ORM\Association\BelongsTo $CategoryDatasets
 *
...
class FaqsTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->belongsTo('CategoryDatasets', [
    ...
    {
        $rules->add($rules->existsIn(['category_dataset_id'], 'CategoryDatasets'), ['errorField' => 'category_dataset_id']);
